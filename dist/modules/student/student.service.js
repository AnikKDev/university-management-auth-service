...
exports.deleteSingleStudentService = exports.updateSingleStudentService = exports.getSingleStudentService = exports.getAllStudentsService = void 0;
const http_status_1 = __importDefault(require("http-status"));
const ApiError_1 = __importDefault(require("../../errors/ApiError"));
const paginationHelpers_1 = require("../../helpers/paginationHelpers");
const student_constants_1 = require("./student.constants");
const student_model_1 = __importDefault(require("./student.model"));
const getAllStudentsService = (paginationOptions, filters) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield student_model_1.default.find(whereCondition)
...
const updateSingleStudentService = (id, updatedData) => __awaiter(void 0, void 0, void 0, function* () {
    // check whether the data exists
    const isExist = yield student_model_1.default.findById(id);
    if (!isExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, "The student that you are trying to update is not found");
    }
    const { name, guardian, localGuardian } = updatedData, studentData = __rest(updatedData, ["name", "guardian", "localGuardian"]);
    ...
    const result = yield student_model_1.default.findOneAndUpdate({ _id: id }, updatedStudentData, {
        new: true,
    });
    return result;
});
