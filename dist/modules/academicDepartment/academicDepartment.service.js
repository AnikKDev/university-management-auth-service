...
exports.deleteSingleDepartmentService =
  ...
  exports.getAllAcademicDepartmentService =
  exports.createAcademicDepartmentService =
    void 0;
const paginationHelpers_1 = require("../../helpers/paginationHelpers");
const academicDepartment_constant_1 = require("./academicDepartment.constant");
const academicDepartmentModel_1 = __importDefault(
  require("./academicDepartmentModel")
);
const createAcademicDepartmentService = data =>
...
const getAllAcademicDepartmentService = (paginationOptions, filters) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
      andConditions.push({
        $or: academicDepartment_constant_1.searchableAcademicDepartment.map(
          field => ({
            [field]: {
              $regex: searchTerm,
              $options: "i",
    ...
    const result = yield academicDepartmentModel_1.default
      .find(whereCondition)
      .sort(sortConditions)
      .skip(skip)
      .limit(limit)
...
const updateSingleDepartmentService = (id, updatedData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicDepartmentModel_1.default.findOneAndUpdate(
      { _id: id },
      updatedData,
      {
        new: true,
...
const deleteSingleDepartmentService = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicDepartmentModel_1.default.findByIdAndDelete(
      id
    );
    return result;
  });
