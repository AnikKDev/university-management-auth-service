...
exports.deleteSingleAdminService =
  exports.updateSingleAdminService =
  exports.getSingleAdminService =
  exports.getAllAdminsService =
    void 0;
...
const getAllAdminsService = (filters, paginationOptions) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const totalData = yield admin_model_1.default.countDocuments(
      whereCondition
    );
    return {
      meta: {
...
// get single admin
const getSingleAdminService = adminId =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield admin_model_1.default
      .findById(adminId)
      .populate("managementDepartment");
...
// update single admin
const updateSingleAdminService = (adminId, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
    // check if exists
    ...
    const result = yield admin_model_1.default.findOneAndUpdate(
      { _id: adminId },
      data,
      {
        new: true,
...
// delete service
const deleteSingleAdminService = id =>
  __awaiter(void 0, void 0, void 0, function* () {
