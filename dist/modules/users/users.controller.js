...
exports.createStudentController = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    */
    ...
    const result = yield (0, users_service_1.createStudentService)(
      student,
      userData
    );
...
exports.createFacultyController = (0, catchAsync_1.catchAsync)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const _b = req.body,
      { faculty } = _b,
      userData = __rest(_b, ["faculty"]);
    const result = yield (0, users_service_1.createFacultyService)(
      faculty,
      userData
    );
    (0, sendResponse_1.sendResponse)(res, {
