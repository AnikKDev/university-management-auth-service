...
exports.updateAcademicSemesterZodSchema = exports.createAcademicSemesterZodSchema = void 0;
...
exports.createAcademicSemesterZodSchema = zod_1.z.object({
    body: zod_1.z.object({
        title: zod_1.z.enum([...academicSemester_constant_1.academicSemesterConstantTitle], {
            required_error: "Title is required",
        }),
        year: zod_1.z.string({
            required_error: "Year is required",
        }),
        code: zod_1.z.enum([...academicSemester_constant_1.academicSemesterConstantCode], {
            required_error: "Semester code is required",
        }),
        startMonth: zod_1.z.enum([...academicSemester_constant_1.academicSemesterConstantMonth], {
            required_error: "Start month is required",
        }),
        endMonth: zod_1.z.enum([...academicSemester_constant_1.academicSemesterConstantMonth], {
...
exports.updateAcademicSemesterZodSchema = zod_1.z
    ...
    .refine(data => (data.body.updatedData.title && data.body.updatedData.code) ||
