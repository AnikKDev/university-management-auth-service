...
const academicDepartment_router_1 = __importDefault(require("../../modules/academicDepartment/academicDepartment.router"));
const academicFaculty_router_1 = __importDefault(require("../../modules/academicFaculty/academicFaculty.router"));
const academicSemester_router_1 = __importDefault(require("../../modules/academicSemester/academicSemester.router"));
const admin_router_1 = __importDefault(require("../../modules/admin/admin.router"));
const managementDepartment_router_1 = __importDefault(require("../../modules/managementDepartment/managementDepartment.router"));
...
const moduleRoutes = [
    ...
    { path: "/management-departments", router: managementDepartment_router_1.default },
