...
const findLastStudentId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const lastStudent = yield users_model_1.default
...
const generateStudentId = academicSemester =>
  __awaiter(void 0, void 0, void 0, function* () {
    const currentUserId =
      (yield (0, exports.findLastStudentId)()) || String(0).padStart(5, "0");
    let incrementedId = (parseInt(currentUserId) + 1)
      .toString()
      .padStart(5, "0");
    // 2025 --> 25
    incrementedId = `${
...
const findLastFacultyId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const lastFaculty = yield users_model_1.default
...
const findLastAdminId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const lastAdminId = yield users_model_1.default
      .findOne({ role: "admin" }, { _id: 0, id: 1 })
      .sort({ createdAt: -1 })
      .lean();
    return (
...
const generateAdminId = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const currentAdminId =
      (yield findLastAdminId()) || (0).toString().padStart(5, "0");
