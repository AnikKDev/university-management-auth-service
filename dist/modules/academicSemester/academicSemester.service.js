...
exports.deleteSingleSemesterService = exports.updateSingleSemesterService = exports.getSingleSemesterService = exports.getAllSemestersService = exports.createAcademicSemesterService = void 0;
const http_status_1 = __importDefault(require("http-status"));
const ApiError_1 = __importDefault(require("../../errors/ApiError"));
const paginationHelpers_1 = require("../../helpers/paginationHelpers");
const academicSemester_constant_1 = require("./academicSemester.constant");
const academicSemesterModel_1 = __importDefault(require("./academicSemesterModel"));
const createAcademicSemesterService = (data) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllSemestersService = (paginationOptions, filters) => __awaiter(void 0, void 0, void 0, function* () {
    const { searchTerm } = filters, filtersData = __rest(filters, ["searchTerm"]);
    const andConditions = [];
    if (searchTerm) {
        andConditions.push({
            $or: academicSemester_constant_1.searchableAcademicSemester.map(field => ({
                [field]: {
                    $regex: searchTerm,
                    $options: "i",
                },
    ...
    const result = yield academicSemesterModel_1.default.find(whereCondition)
        .sort(sortConditions)
        .skip(skip)
        .limit(limit);
...
const updateSingleSemesterService = (id, updatedData) => __awaiter(void 0, void 0, void 0, function* () {
    if (updatedData.title &&
        updatedData.code &&
        academicSemester_constant_1.academicSemesterTitleCodeMapper[updatedData.title] !== updatedData.code) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid semester code");
    }
    const result = yield academicSemesterModel_1.default.findOneAndUpdate({ _id: id }, updatedData, {
        new: true,
    });
    return result;
});
